...
En teoría de la información, la idea central es que la **información** está asociada a la **reducción de incertidumbre**. Un suceso muy improbable aporta más información cuando ocurre que un suceso casi seguro.
...
**Concepto clave:** la información no mide “importancia semántica”, sino **sorpresa probabilística**.

**[Figura 2.1]:** Curva de autoinformación $I(x)=-\log_2 p(x)$ en función de la probabilidad. La figura debe mostrar una curva decreciente y convexa: cuando $p(x)$ es cercana a 1, la información es casi nula; cuando $p(x)$ es pequeña, la información crece rápidamente. La interpretación visual es fundamental para entender que los sucesos raros son los que más reducen la incertidumbre del observador.
...
**Conclusión:** el símbolo menos probable aporta más información.
...
Así se demuestra que la entropía máxima ocurre para distribución uniforme.

**[Figura 2.2]:** Curva de entropía binaria $H_2(p) = -p\log_2 p -(1-p)\log_2(1-p)$ para $0\le p\le1$. La figura debe ser simétrica respecto a $p=0.5$, nula en $p=0$ y $p=1$, y máxima en $p=0.5$ con valor 1 bit. Esta representación ayuda a visualizar cómo la incertidumbre de una fuente binaria depende del balance entre las probabilidades de 0 y 1.

#### Ejemplo 2.2: Entropía de una fuente binaria
...
#### Ejemplo 2.4: Redundancia de una fuente ternaria
...
#### Ejemplo 2.5: Entropía conjunta y condicional
...
#### Ejemplo 2.7: Información mutua en un BSC con entrada equiprobable
...
**[Figura 2.4]:** Capacidad del BSC $C=1-H_2(p)$ frente a la probabilidad de cruce $p$. La figura debe mostrar una curva que parte de 1 bit en $p=0$, desciende de forma suave y alcanza 0 en $p=0.5$. La descripción debe resaltar que la capacidad refleja el máximo caudal fiable de información y que el canal pierde utilidad informativa a medida que crece la probabilidad de error.

#### Ejemplo 2.8: Capacidad de un BSC
...
#### Ejemplo 2.10: Duración de muestra y efecto de apertura
...
#### Ejemplo 2.11: Paso de cuantización y error máximo
...
#### Ejemplo 2.12: Razón conceptual para usar cuantización no lineal
...
#### Ejemplo 2.13: Compresión con Ley-$\mu$
...
#### Ejemplo 2.14: Compresión con Ley-A
...
#### Ejemplo 2.15: SQNR para varios números de bits
...
#### Ejemplo 2.16: Codificación PCM de una muestra
...
#### Ejemplo 2.17: Tasa de bits de un sistema PCM multicanal
...
#### Ejemplo 2.18: Diseño básico de un sistema PCM
...
#### Ejemplo 2.19: Interpretación de una capacidad dada
...
#### Ejemplo 2.21: Cálculo de SNR a partir de $E_b/N_0$
...
#### Ejemplo 2.22: Energía por bit requerida para una eficiencia dada
...
#### Ejemplo 2.23: Ubicación de un sistema en el plano de Shannon
...
#### Ejemplo 2.24: Modelo binario unidimensional
...
#### Ejemplo 2.25: ML para señales binarias antipodales
...
#### Ejemplo 2.26: MAP para símbolos binarios con priori desiguales
...
#### Ejemplo 2.27: Equivalencia ML/MAP
...
#### Ejemplo 2.28: Región de decisión binaria
...
#### Ejemplo 2.29: Probabilidad de error binaria
...
#### Ejemplo 2.30: BER de BPSK en términos de $E_b/N_0$
...
#### Ejemplo 2.31: Comparación ML y MAP en un caso concreto
...
- La probabilidad de error en sistemas binarios gausianos se expresa mediante la función $Q$.

---

## Resumen general de la unidad

En esta unidad se han desarrollado cuatro bloques fundamentales de las comunicaciones digitales:
...
En conjunto, estos resultados conectan la producción de información por una fuente, su digitalización, su transmisión por canales ruidosos y su recuperación óptima en recepción. Constituyen la base conceptual sobre la cual se construyen los sistemas modernos de telecomunicaciones móviles, satelitales, ópticas y de redes inalámbricas avanzadas.
...
2. T. M. Cover y J. A. Thomas, *Elements of Information Theory*, 2nd ed. Wiley, 2006. DOI: $10.1002/047174882X$.
3. J. G. Proakis y M. Salehi, *Digital Communications*, 5th ed. McGraw-Hill, 2008.
...
6. A. Papoulis y S. U. Pillai, *Probability, Random Variables, and Stochastic Processes*, 4th ed. McGraw-Hill, 2002.
7. J. R. Pierce, “Information Theory,” *Scientific American*, vol. 200, no. 1, pp. 42–51, 1959. DOI: $10.1038/scientificamerican0159-42$.
