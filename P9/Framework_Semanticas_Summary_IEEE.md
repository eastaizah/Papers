...
### C. Semantic Fidelity vs. Compression Rate

Simulation results confirm that RSE improves monotonically with bottleneck dimension $k$, consistent with the rate-distortion bound demonstrated in Section XI.B, which shows the proposed system achieves TSR = 0.878 at $k = 32$. The fidelity metric breakdown is:
...
### E. Multi-Channel Performance Analysis
